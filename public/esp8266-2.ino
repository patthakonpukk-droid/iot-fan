...
const char* password = "";
// เติม ?id=1 ต่อท้าย
const char* apiUrl = "https://iot-fan-enlic.vercel.app/api/device?id=2";
// *** ต้องตรงกับค่า DEVICE_SECRET_2 ใน Environment Variables บน Vercel ***
const char* deviceSecret = "7kSjfWyvRA6jbBIrix0iJO4p";
